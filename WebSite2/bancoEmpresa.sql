...
CREATE TABLE `acesso` (
  ...
  CONSTRAINT `fk_Acesso_Funcionario1` FOREIGN KEY (`emailFuncionario`) REFERENCES `funcionario` (`emailFuncionario`)
...
INSERT INTO `acesso` VALUES ('1234','gerente@gmail.com'),('1234','huedoctor35@gmail.com');
...
CREATE TABLE `departamento` (
  ...
  `foneDepartamento` varchar(15) DEFAULT NULL,
...
INSERT INTO `departamento` VALUES ('RH','RecursosHumannos','1199000000'),('TI','TecnologiaDaInformação','1199900000');
...
INSERT INTO `funcionario` VALUES ('gerente@gmail.com','Geraldo','Gerente',50000,'RH'),('huedoctor35@gmail.com','Eddie','TI',10000,'RH');
...
-- Dump completed on 2023-03-31  8:48:45
